...
figure_data_file = Path(figure_data_folder / "fig_mf_4.pickle")
if figure_data_file.exists() == True:
    ...
    wait_step_labels_MF = figure_data["wait_step_labels_MF"]
    group_idx_arr_MF = figure_data["group_idx_arr_MF"]
else:
    group_histories_MF = {}
    labels_MF = []
    wait_step_labels_MF = []
    # wait_steps = [1, 5, 10, 20, 50, 100]
    group_idx_arr_MF = [0, 35, 36, 37, 33, 34]
    # group_idx_arr_MF = [0]
    ...
    for group_idx in group_idx_arr_MF:
        ...
        wait_step_labels_MF.append(config_dict["enKF"]["wait_steps"])
    ...
    fp.pickle_file(figure_data_file, 
                   {"group_averages_MF": group_averages_MF, 
                    ...
                    "labels_MF": labels_MF,
                    "wait_step_labels_MF": wait_step_labels_MF,
                    "group_idx_arr_MF": group_idx_arr_MF,
                    })

# colors  
legend_labels = []
for wait_step_label in wait_step_labels_MF:
    legend_label = f"${wait_step_label}$"
...
plt.figlegend(handles, 
              ...
              frameon=False)
# plt.legend()
fig.savefig(figure_folder/"fig_mf_4.png", bbox_inches='tight')
fig.savefig(figure_folder/"fig_mf_4.pdf", bbox_inches='tight')